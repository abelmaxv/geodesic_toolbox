"""
Funnel / FHMC benchmark -- one fixed configuration.
From funnel_fhmcC_sweep.py. Set reduced_flip to toggle the momentum flip.

    cd benchmarks && python funnel_fhmc_benchmark.py
"""
import torch
...
PARAMS = {"beta": 0.25, "l": 20, "N_fx": 8, "gamma": 0.01,
